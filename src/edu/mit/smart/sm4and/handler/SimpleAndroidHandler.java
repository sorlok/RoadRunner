 ...
 */
public class SimpleAndroidHandler implements Runnable {
	private AbstractMessageHandler handler;
	private Message message;
	private Connector connector;
	private MessageParser parser;
	
	public SimpleAndroidHandler(AbstractMessageHandler handler, Message message, Connector connector, MessageParser parser) {
